...
#'          model.
#'
#'          When using \code{pmtree}, note the following
...
#'
#' @return \code{pmtree} returns the final classification tree as a 
...
#' tree1=pmtree(Y~treatment | .,data,maxdepth=3)
#'
#' #
#' # ... an example with a continuous outcome variable
...
#' 
#' # fit a classification tree
#' tree2=pmtree(Y~treatment | .,data,types=types)
#' 
#' #
...
#' 
#' # fit a classification tree
#' tree3=pmtree(Surv(Y,C)~treatment | .,data,maxdepth=2)
#' 
#' #
#' # ... an example with a survival outcome variable
...
#' tree4=pmtree(Surv(Y,C)~treatment | .,data,types=types,maxdepth=2)
#' tree5=pmtree(Surv(Y,C)~treatment |X3+X4,data,types=types,
#'              maxdepth=2)
#'
#' @export

pmtree <- function(formula,
                   data,
                   types=NULL,
                   nmin=5,
                   maxdepth=-7,
